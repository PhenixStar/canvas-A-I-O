...
import { AlertTriangle, Clock, Save, Discard } from "lucide-react"
...
export const AutoSaveRestoreDialog = memo(
    function AutoSaveRestoreDialog({
        open,
        onOpenChange,
                    ...
                    <DialogFooter className="flex-col sm:flex-row gap-2">
                        {hasAutoSaves ? (
                            <>
                                ...
                                >
                                    <Discard className="h-4 w-4 mr-2" />
                                    {dict.autoSave?.discard ||
                                        "Discard All"}
                                </Button>
                                <Button
                                    variant="outline"
...
export function useAutoSaveRecovery() {
    const { autoSaveState } = useDiagram()
