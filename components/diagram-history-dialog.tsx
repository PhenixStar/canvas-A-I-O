...
import { Clock, FileText, History, Search } from "lucide-react"
...
export const DiagramHistoryDialog = memo(function DiagramHistoryDialog({
    open,
    onOpenChange,
            ...
            <DialogContent className="max-w-4xl max-h-[85vh] overflow-hidden flex flex-col">
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-2">
                        ...
                        <span>{dict.history?.title || "Diagram History"}</span>
                    </DialogTitle>
                    <DialogDescription>
                ...
                {loading ? (
                    ...
                    <div className="flex-1 flex items-center justify-center text-muted-foreground">
                        {searchQuery
                            ...
                            : dict.history?.noHistory || "No history available"}
                    </div>
                ) : (
