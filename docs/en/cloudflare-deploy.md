...
## Step 3 â€” Choose your deployment type
...
## Step 4 â€” Register a workers.dev subdomain (first-time only)

Before your first deployment, you need a workers.dev subdomain.

**Option 1: Via Cloudflare Dashboard (Recommended)**

Visit: https://dash.cloudflare.com â†’ Workers & Pages â†’ Overview â†’ Set up a subdomain
...
**Fix:** Go to https://dash.cloudflare.com â†’ Workers & Pages â†’ Set up a subdomain.
